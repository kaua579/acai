 ...
 * 
 * @return bool  caso o usuário seja removido com sucesso.
 * @throws Exception caso ocorra uma falha na exclusão.
 */
 ...
 * 
 * @return array|null Um array associativo com os dados do pedido, ou `null` caso não encontre o pedido.
 * @throws null caso não encontre o pedido com o ID fornecido.
 */
 ...
 * 
 * @return bool  caso o pagamento seja removido com sucesso.
 * @throws false caso ocorra uma falha na exclusão.
 */
 ...
 * @throws null caso não encontre o pagamento com o ID fornecido.
 */
 ...
 * 
 * @param mysqli $conexao Uma conexão com o banco.
 * @return array Lista de atendentes, onde cada atendente é representado por um array com as chaves:
 ...
 * 
 * @return bool `true` caso o atendente seja removido com sucesso.
 * @throws false caso ocorra uma falha na exclusão.
 */
 ...
 * 
 * @return array Associative array com os dados do atendente, onde as chaves são:
 *     - 'idatendente' : ID do atendente.
 *     - 'idade' : Idade do atendente.
 *     - 'horario_chegada' : Horário de chegada do atendente.
 *     - 'horario_saida' : Horário de saída do atendente.
