...
(idproduto, nome, tamanho, complemento_g, complemento_p, cobertura) 
VALUES 
(1, 'Açai', '200 ml', 'avelã', 'morango', 'whey'),
(2, 'Açai', '300 ml', 'granola', 'banana', 'mel'),
(3, 'Açai', '400 ml', 'chocolate', 'amendoim', 'leite ninho'),
(4, 'Açai', '500 ml', 'paçoca', 'morango', 'leite condensado'),
(5, 'Açai', '250 ml', 'avelã', 'granola', 'choco power');
